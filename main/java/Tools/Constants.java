...
public class Constants {
    ...
    // 快捷调用一
    public static String callPathText = "";
    public static String callArgsText = "";
    public static boolean selected04 = true;

    // 快捷调用二
    public static String callPathText2 = "";
    public static String callArgsText2 = "";
    public static boolean selected042 = true;
